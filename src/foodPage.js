...
const foodPage = (function() {
    ...
    const bunsItem = new MenuItem(Buns, "Sauteed Mushroom and Garlic Buns", "Embark on a gastronomic journey with our Mystic Forest Buns, a spellbinding union of earthy mushrooms, aromatic garlic, and pillowy buns that transport you to the heart of an enchanted woodland. Crafted with care, these sautéed delights promise a symphony of flavors that dance on your palate.");
    ...
    const render = function() {
        ...
        desertItemsWrapper.classList.add("meno-items-wrapper");
